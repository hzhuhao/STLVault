  ...
  return (
    <div className="w-screen sm:w-96 bg-vault-900 border-l border-vault-700 flex flex-col h-full shadow-2xl z-20 relative">
      ...
      <div className="p-4 border-b border-vault-700 flex justify-between items-center">
        ...
        <button
          onClick={onClose}
          className="text-slate-400 hover:text-white p-1 rounded hover:bg-vault-800"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
          ...
          <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {model.tags.length > 0 ? (
                    model.tags.map((tag) => (
                      <span
                        key={tag}
                        className="flex items-center gap-1 text-xs bg-vault-800 border border-vault-700 text-slate-300 px-2 py-1 rounded-full"
                      >
            ...
            {isEditing && (
              <div className="flex gap-2 pt-2">
                <button
                  onClick={handleSave}
                  className="flex-1 bg-green-600 hover:bg-green-500 text-white py-1.5 rounded text-xs font-medium flex items-center justify-center gap-1"
                >
